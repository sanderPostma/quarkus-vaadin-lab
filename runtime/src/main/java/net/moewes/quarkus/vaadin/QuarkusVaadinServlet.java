...
public class QuarkusVaadinServlet extends VaadinServlet {
    ...
    public void init(ServletConfig servletConfig) throws ServletException {
        try {
            ...
            /**
             Vaadin 15+
             Object routeRegistryWrapper = servletContext.getAttribute("com.vaadin.flow.server.startup.ApplicationRouteRegistry$ApplicationRouteRegistryWrapper");
             Field field = ApplicationRouteRegistry.class.getDeclaredClasses()[0].getDeclaredField("registry");
             field.setAccessible(true);
             ApplicationRouteRegistry routeRegistry = (ApplicationRouteRegistry)field.get(routeRegistryWrapper);
